...
/**
  * LDY - 5 instructions
  */
object LDY_Imm extends Instruction(UByte(0xA2), 2, 2){
  override def execute(memory: MemoryMap, reg: Reg6502, args: UByte*): Unit = {
    reg.Y = args(0)
    reg.updateZN(reg.Y)
  }
...
object LDY_ZP extends Instruction(UByte(0xA6), 2, 3){
  override def execute(memory: MemoryMap, reg: Reg6502, args: UByte*): Unit = {
...
object LDY_ZP_X extends Instruction(UByte(0xB6), 2, 4){
  override def execute(memory: MemoryMap, reg: Reg6502, args: UByte*): Unit = {
...
object LDY_ABS extends Instruction(UByte(0xAE), 3, 4){
  override def execute(memory: MemoryMap, reg: Reg6502, args: UByte*): Unit = {
...
object LDY_ABS_X extends Instruction(UByte(0xBE), 3, 4){
  override def execute(memory: MemoryMap, reg: Reg6502, args: UByte*): Unit = {
